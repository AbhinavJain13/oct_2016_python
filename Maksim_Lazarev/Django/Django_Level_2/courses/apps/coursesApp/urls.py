...
urlpatterns = [
    #   url(r'^$', method_to_run)
        ...
        url(r"^courses/add$", views.coursesAdd, name="coursesAdd"),
        url(r"^courses/destroy/(?P<id>\d+)$", views.coursesDestroy, name="coursesDestroy"),
        url(r"^courses/delete$", views.coursesDelete, name="coursesDelete"),
